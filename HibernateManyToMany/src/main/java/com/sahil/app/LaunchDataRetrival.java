...
public class LaunchDataRetrival {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            Student01 s1 = session.get(Student01.class, 1);
            System.out.println(s1.getS_id());
            System.out.println(s1.getS_name());
            
            Set<Courses01> st1 = s1.getCourse();
            for(Courses01 c : st1) {
            	System.out.println(c);
            }
            
            Student01 s2 = session.get(Student01.class, 2);
            System.out.println(s2.getS_id());
            System.out.println(s2.getS_name());
            
            Set<Courses01> st2 = s2.getCourse();
            for(Courses01 c : st2) {
            	System.out.println(c);
            }
//            
            Student01 s3 = session.get(Student01.class, 3);
            System.out.println(s3.getS_id());
            System.out.println(s3.getS_name());
            
            Set<Courses01> st3 = s3.getCourse();
            for(Courses01 c : st3) {
            	System.out.println(c);
            }
